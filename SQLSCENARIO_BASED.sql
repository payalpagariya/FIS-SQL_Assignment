...
--1.DETAILS OF THE BOOKS WRITTEN BY AUTHOR WHOSE NAME ENDS WITH ER.
...
SELECT * FROM BOOKS
SELECT * FROM REVIEWS
--3. DISPLAY REVIEWER NAME WHO REVIEWED MORE THAN ONE BOOK.
...
--4. DISPLAY NAME FOR CUSTOMER FROM ABOVE CUSTOMER TABLE WHO LIVE IN SAME ADDRESS WHICH HAS CHARACTER 'O' ANYWHERE IN ADDRESS
...
--5. DISPLAY THE DATE, TOTAL NO. OF CUSTOMER PLACED ORDER ON SAME DATE
...
--7. DISPLAY THE GENDER, TOTAL NO. OF MALE AND FEMALE FROM ABOVE RELATION
...
--8. RETRIEVE THE COURSENAME AND THE NUMBER OF STUDENTS REGISTERED FOR EACH COURSE BETWEEN 2018-01-02 AND 2018-02-28 AND ARRANGE THE RESULT BY COURSEID IN DESCENDING ID
SELECT C_NAME,COUNT(*) AS 'NO. OF STUDENTS' 
FROM COURSEDETAILS D JOIN COURSEREGISTRATION R 
ON CID = C_ID 
...
SELECT * FROM STUDENTDETAILS
--10. DISPLAY ALL THE STUDENT NAME IN REVERSE ORDER AND CAPITALIZE ALL THE CHARACTERS IN LOCATION
SELECT REVERSE(NAME) AS 'REVERSED NAME', UPPER(LOCATION) AS 'LOCATION(CAPITALIZED)'
FROM STUDENTDETAILS
...
--11. CREATE VIEW TABLE TO DISPLAY THE PRODUCTNAME, ORDERED QUANTITY AND ORDERNUMBER FROM THE ABOVE RELATIONS
CREATE VIEW VWPRODUCTORDER 
AS 
SELECT 
...
SELECT * FROM COURSEREGISTRATION
SELECT * FROM STUDENTDETAILS
--12. DISPLAY THE COURSENAME REGISTERED BY STUDENT NISHA
